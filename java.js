...
<body>
    ...
    <div class="problem">
        ...
        <input type="number" id="atmBalance" placeholder="Balance">
        <input type="number" id="atmAmount" placeholder="Amount">
        <input type="text" id="atmPin" placeholder="PIN">
        <input type="text" id="atmEnteredPin" placeholder="Entered PIN">
        <button onclick="testAtmWithdrawal()">Withdraw</button>
        <p id="atmResult"></p>
    </div>
    <div class="problem">
        <h2>2. Online Shopping Discount & Free Shipping</h2>
        <input type="number" id="orderAmount" placeholder="Order Amount">
        <button onclick="testCalculateFinalAmount()">Calculate Final Amount</button>
        <p id="shoppingResult"></p>
    </div>
    <div class="problem">
        <h2>3. Student Grading System with Extra Credit</h2>
        <input type="number" id="studentMarks" placeholder="Marks">
        <input type="number" id="attendance" placeholder="Attendance">
        <button onclick="testCalculateGrade()">Calculate Grade</button>
        <p id="gradeResult"></p>
    </div>
    <div class="problem">
        <h2>4. Smart Traffic Light System</h2>
        <input type="text" id="trafficDensity" placeholder="Traffic Density">
        <button onclick="testTrafficLightControl()">Get Green Light Duration</button>
        <p id="trafficResult"></p>
    </div>
    <div class="problem">
        <h2>5. Movie Ticket Pricing with Time and Age Discount</h2>
        <input type="number" id="age" placeholder="Age">
        <input type="number" id="showTime" placeholder="Show Time (24h)">
        <button onclick="testCalculateTicketPrice()">Calculate Ticket Price</button>
        <p id="ticketResult"></p>
    </div>
<div class="problem">
        <h2>6. Job Application Filter</h2>
        <input type="number" id="jobAge" placeholder="Age">
        <input type="number" id="experience" placeholder="Experience (years)">
        <input type="text" id="qualification" placeholder="Qualification">
        <button onclick="testIsEligibleForJob()">Check Eligibility</button>
        <p id="jobResult"></p>
    </div>
    <div class="problem">
        <h2>7. E-commerce Coupon Redemption</h2>
        <input type="number" id="couponOrderAmount" placeholder="Order Amount">
        <input type="text" id="couponCode" placeholder="Coupon Code">
        <button onclick="testApplyCoupon()">Apply Coupon</button>
        <p id="couponResult"></p>
    </div>
    <div class="problem">
        <h2>8. Fitness Membership Plan</h2>
        <input type="text" id="planType" placeholder="Plan Type (Basic/Premium/VIP)">
        <input type="checkbox" id="wantsTrainer"> Wants Trainer
        <input type="checkbox" id="wantsDietPlan"> Wants Diet Plan
        <button onclick="testChoosePlan()">Choose Plan</button>
        <p id="planResult"></p>
    </div>
    <div class="problem">
        <h2>9. Electricity Bill Calculation with Peak Hours</h2>
        <input type="number" id="units" placeholder="Units">
        <input type="number" id="timeOfDay" placeholder="Time of Day (24h)">
        <button onclick="testCalculateElectricityBill()">Calculate Bill</button>
        <p id="billResult"></p>
    </div>
    <div class="problem">
        <h2>10. Flight Ticket Booking System</h2>
        <input type="text" id="classType" placeholder="Class Type (Business/First)">
        <input type="number" id="luggageWeight" placeholder="Luggage Weight (kg)">
        <input type="checkbox" id="isStudent"> Is Student
        <input type="checkbox" id="isSenior"> Is Senior
        <button onclick="testCalculateFlightFare()">Calculate Fare</button>
        <p id="flightResult"></p>
    </div>
    <script>
        ...
        function testTrafficLightControl() {
        ...
        function testCalculateTicketPrice() {
        ...
        function testCalculateFlightFare() {
